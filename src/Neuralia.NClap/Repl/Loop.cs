...
using Neuralia.NClap.ConsoleInput;
using Neuralia.NClap.Exceptions;
using Neuralia.NClap.Metadata;
using Neuralia.NClap.Parser;
using Neuralia.NClap.Utilities;

namespace Neuralia.NClap.Repl
{
    /// <summary>
...
#pragma warning disable RS0026 // Do not add multiple public overloads with optional parameters
        ...
        public CommandResult ExecuteOnce(Action<ICommand> callback = null)
        {
